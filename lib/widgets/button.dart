...
import '../utils/base_controllers.dart';
import '/utils/constants.dart';
import '/utils/wgt.dart';
...
class Button extends StatelessWidget {
  ...
  const Button({
    ...
    this.disabledBackgroundColor = kColorBg,
    ...
    return ElevatedButton(
      ...
      style: ButtonStyle(
        minimumSize: MaterialStateProperty.resolveWith((states) {
          return const Size(kSizeMinButtonWidth, kSizeMinButtonHeight);
        }),
        ...
        padding: MaterialStateProperty.all(
            const EdgeInsets.symmetric(vertical: kPaddingXS)),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(text,
              style: TextStyle(
                color: handler != null ? textColor : disabledTextColor,
